...
Finally, a \texttt{GUICommand}:

\noindent
\ttfamily
\hlstd{}\hllin{\ 1\ }\hlkwd{MK\textunderscore GUI\textunderscore COMMAND}\hlstd{}\hlopt{(\ }\hlstd{myCommand}\hlopt{,\ }\hlstd{invokeThisMethod}\hlopt{,\ );}\\
\hllin{\ 2\ }\hlstd{}\hlkwb{void\ }\hlstd{myCommand}\hlopt{::}\hlstd{}\hlkwd{invokeThisMethod}\hlstd{}\hlopt{(\ }\hlstd{string\ params\ }\hlopt{)\ \usebox{\hlboxopenbrace}}\\
\hllin{\ 3\ }\hlstd{}\hlstd{\ \ \ \ }\hlstd{}\hlslc{//\ My\ code\ goes\ in\ here}\\
\hllin{\ 4\ }\hlstd{}\hlopt{\usebox{\hlboxclosebrace}}\hlstd{}\\
\mbox{}
\normalfont
