...
\begin{figure}
  ...
  \end{center}
  \caption[An example of how Project Natal projects a noisy depth-map onto the human skeleton]{An example of how Project Natal projects a noisy depth-map onto the human skeleton, \copyright 2009 Microsoft}
  \label{natal}
\end{figure}
