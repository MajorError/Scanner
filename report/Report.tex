...
\begin{figure}
  \begin{center}
        ...
        \begin{tikzpicture}[scale=0.6]
          ...
          \begin{class}[text width=90px]{VisionProcessor}{0,-4}
            \implement{Plugin}
          ...
          \begin{class}[text width=100px]{GUICommand}{6.2,-5}
            \implement{Plugin}
          ...
          \begin{class}[text width=35px]{Key}{3,-12}
            \inherit{GUICommand}
            \operation{handle}
          \end{class}

          \begin{class}[text width=35px]{Edge}{6,-12}
            \inherit{GUICommand}
            \operation{bisect}
          \end{class}

          \begin{class}[text width=35px]{Vertex}{9,-12}
            \inherit{GUICommand}
            \operation{move}
          \end{class}
