...
\begin{tikzpicture}
  ...
  \begin{class}[text width=125px]{Point}{8,0}
  ...
  \composition{Environment}{faces}{0..*}{PolyFace}
  \composition{Environment}{edges}{0..*}{Edge}
  \composition{Environment}{points}{0..*}{Point}
