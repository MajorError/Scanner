...
\hlstd{\usebox{\hlboxlessthan}}\hlkwc{root}\hlstd{\usebox{\hlboxgreaterthan}}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ \ }\hlnum{8\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{54\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ }\hlkwc{}\hlstd{}\hlnum{100}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{}\hlkwc{cam}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{29\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{53}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{29\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{53}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{}\hlkwc{ptam}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{13\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{24}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{13\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{24}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{}\hlkwc{gui}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ \ }\hlnum{5\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{9}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{13\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{23}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ }\hlstd{}\hlkwc{DrawStuff}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{15\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlnum{8\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{14}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlkwc{DrawPoints}\hlstd{\ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ \ }\hlnum{7\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{12}\hlstd{\%}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlnum{7\ }\hlstd{}\hlkwc{ms}\hlstd{\ \ \ }\hlkwc{}\hlstd{}\hlnum{12}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlkwc{DrawFeatures}\hlstd{\ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{20\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{20\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlkwc{DrawTarget}\hlstd{\ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ }\hlnum{842\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{2}\hlstd{\%}\hlstd{\ \ \ \ }\hlstd{}\hlnum{842\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{2}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ }\hlstd{}\hlkwc{DrawPolys}\hlstd{\ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{65\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ }\hlstd{}\hlnum{200\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ \ \ }\hlstd{}\hlkwc{textureTidyup}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{9.0}\hlstd{\ \ \ \ \ }\hlnum{19\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{19\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ \ \ }\hlstd{}\hlkwc{retrieveTexture}\hlstd{\ \ }\hlkwc{}\hlstd{}\hlnum{9.0}\hlstd{\ \ \ \ \ }\hlnum{12\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{12\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ \ \ \ \ \ \ }\hlstd{}\hlkwc{drawTriangles}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{9.0}\hlstd{\ \ \ \ }\hlnum{104\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ }\hlstd{}\hlnum{104\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{}\hlkwc{commands}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{19\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{19\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{}\hlkwc{textures}\hlstd{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }\hlkwc{}\hlstd{}\hlnum{1.0}\hlstd{\ \ \ \ \ }\hlnum{34\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hlstd{\ \ \ \ \ }\hlstd{}\hlnum{34\ }\hlstd{}\hlkwc{us}\hlstd{\ \ \ \ }\hlkwc{}\hlstd{}\hlnum{0}\hlstd{\%}\hspace*{\fill}\\
\mbox{}
\normalfont
\normalsize
