...
\begin{figure}
  \begin{center}
    ...
    \hspace{10px}
    \subfigure[Error Map With Model (5.5\%)]{\includegraphics[width=160px]{DeskErrorModel2}\label{errormodel2}}
    \subfigure[Error Map With Model \& UI (12.9\%)]{\includegraphics[width=165px]{DeskErrorModelUI}\label{errormodelui}}
  \end{center}
